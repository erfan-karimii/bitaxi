...
from .serializers import DiscountSerializer , DiscountDetailSerializer,DiscountDeleteSerializer
...
class DiscountView(APIView):
    ...
    def delete(self,request):
        ...
        return Response({"discount":"discount deleted successfully"},status=status.HTTP_204_NO_CONTENT)
