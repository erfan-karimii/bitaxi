...
from .module_settings.arvan import *
from .module_settings.logging import *
from .module_settings.email import * 
from .module_settings.zarinpal import *
from .module_settings.celery_conf import *